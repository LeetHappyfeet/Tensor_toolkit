...
# Ensure alpha, beta, and gamma are defined
alpha, beta, gamma = None, None, None  # Placeholder, replace with actual initialization if available
...
# Ensure to initialize alpha, beta, and gamma before usage
try:
    metric_tensor = threePlusOneBuilder(alpha, beta, gamma)
except Exception as e:
    logging.error(f"Error occurred while computing the metric: {e}")
